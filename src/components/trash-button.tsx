...
export function TrashButton() {
  ...
  return (
    <div className="relative group">
      ...
      {/* Tooltip */}
      <div
        className={`absolute top-full right-0 mt-2 md:top-0 md:left-full md:ml-4 md:mt-0 opacity-0 md:group-hover:opacity-100 transition-all duration-200 pointer-events-none z-50`}
      >
